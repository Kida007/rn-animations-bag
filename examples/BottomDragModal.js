...
import { Text, PanResponder, Animated, Dimensions, View, Easing, SafeAreaView }from 'react-native'
...
class BottomDragModal extends React.Component {
  ...
  render(){
    ...
    const Bstyle = { height:300, backgroundColor:'#273E6F', borderRadius:10, transform:[{ translateY:this.animatedValue}]}
        ...
        <View style={{ flex:1, paddingHorizontal:20}}>
         <Animated.View style={Bstyle} {...this.panResponder.panHandlers}>
           <View style={{ flexDirection:'row', paddingVertical:10, justifyContent:'center'}}>
             <View style={{ height:7, width:40, backgroundColor:'#DEDEDF', borderRadius:5}}/>
           </View>
         </Animated.View>
       </View>
      </SafeAreaView>
